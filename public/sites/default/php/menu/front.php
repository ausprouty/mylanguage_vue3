...
function mylanguage_page_front_laptop($hl_id){
  ...
  $space = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
  $output .= link( mylanguage_t_browser('About us'), 'https://mylanguage.net.au/about') . $space . "\n";
  $output .= link( mylanguage_t_browser('Contact us')  , 'https://mylanguage.net.au/about/'). $space . "\n";
  $output .= link( mylanguage_t_browser('Listen')  , 'https://mylanguage.net.au/listen_online/'. $hl_id) .$space . "\n";
  $output .= link( mylanguage_t_browser('Video')  , 'https://mylanguage.net.au/show/'. $hl_id). $space . "\n";
  $output .= link( mylanguage_t_browser('Bible')  ,'https://mylanguage.net.au/bible/'. $hl_id). $space . "\n";
  $output .= link( mylanguage_t_browser('Meet God')  ,'https://mylanguage.net.au/meet/'. $hl_id). $space . "\n";
  $output .= link( mylanguage_t_browser('Adventure')  ,'https://mylanguage.net.au/study_online/'. $hl_id). $space . "\n";
  $output .= '</td></tr></table>';
  return $output;
}
